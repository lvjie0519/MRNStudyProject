...
let isLoading = true;
export default class ReactNativeVideoDemo extends React.Component{
    ...
    onLoad(data) {
        console.log('lvjie On load fired!');
        isLoading = false;
          ...
          <View style={styles.container}>
              <TouchableOpacity style={styles.fullScreen} onPress={() => { this.setState({ paused: !this.state.paused }) }}>
                  <Video
                    ...
                    source={require('../../res/mp4/broadchurch.mp4')}
    ...
    render() {
        console.log('lvjie controls', this.state.controls)
